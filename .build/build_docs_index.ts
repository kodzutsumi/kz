...
<head>
  ...
  <link id="ddocResetStylesheet" rel="stylesheet" href="core/reset.css">
  <link href="core/comrak.css" rel="stylesheet">
</head>
<body>
  <div class="ddoc">
    <div>
      <nav id="topnav">
        <div class="h-full">
          ...
          <ul class="breadcrumbs"><li>@kz index</li></ul>
          </div>
        </div>
      </nav>
      <div id="content">
