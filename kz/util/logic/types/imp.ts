...
import type { ImpResult, LogicHandler } from './_internal/mod.ts';

import type { LogicCapSet, LogicDefaults } from './types.ts';

/**
 * Represents a logical implied operation on two boolean operands and returns a type based on the provided settings.
 *
 * ## Capabilities
 * - {@linkcode UseUnsafe}
...
> = LogicHandler<ImpResult<OperandA, OperandB>, Settings>;
