...
import type { ConResult, LogicHandler } from './_internal/mod.ts';

import type { LogicCapSet, LogicDefaults } from './types.ts';

/**
 * Represents a logical converse operation on two boolean operands and returns a type based on the provided settings.
 *
 * ## Capabilities
 * - {@linkcode UseUnsafe}
 ...
 * @see [Logic reference - Behavior matrix](https://docs.i11n.io/kz/util/logic/ref/logic/#behavior-matrix) for detailed behavior based on different capability combinations.* @see [Con reference - Behavior matrix](https://docs.i11n.io/kz/util/logic/ref/con/#behavior-matrix) for detailed `Con` behavior based on different capability combinations.
 */
export type Con<
  OperandA extends boolean,
  OperandB extends boolean,
  Settings extends LogicCapSet = LogicDefaults,
> = LogicHandler<ConResult<OperandA, OperandB>, Settings>;
