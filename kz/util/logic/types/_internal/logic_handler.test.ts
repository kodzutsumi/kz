      ...
      describe('$AsSafe (default/implied)', () => {
        describe('$AsRunoff (default/implied)', () => {
          ...
          it('should return false for false', () => {
            type Expected = false;
            type Actual = LogicHandler<false>;
            type Result = IsExact<Expected, Actual>;
          ...
          it('should return boolean for boolean', () => {
            ...
            type Actual = LogicHandler<boolean>;
            type Result = IsExact<Expected, Actual>;
          ...
          it('should return boolean for $UseVote<true>', () => {
            type Expected = boolean;
            type Actual = LogicHandler<$UseVote<true>>;
            type Result = IsExact<Expected, Actual>;
          ...
          it('should return boolean for $UseVote<false>', () => {
            type Expected = boolean;
            type Actual = LogicHandler<$UseVote<false>>;
            type Result = IsExact<Expected, Actual>;
          ...
          it('should return boolean for $UseVote<boolean>', () => {
            type Expected = boolean;
            type Actual = LogicHandler<$UseVote<boolean>>;
            type Result = IsExact<Expected, Actual>;
        ...
        describe('$AsMajority', () => {
          ...
          it('should return true for true', () => {
            type Expected = true;
            type Actual = LogicHandler<true, $Settings>;
            type Result = IsExact<Expected, Actual>;
          ...
          it('should return false for false', () => {
            type Expected = false;
            type Actual = LogicHandler<false, $Settings>;
            type Result = IsExact<Expected, Actual>;
          ...
          it('should return boolean for boolean', () => {
            type Expected = boolean;
            type Actual = LogicHandler<boolean, $Settings>;
            type Result = IsExact<Expected, Actual>;
          ...
          it('should return true for $UseVote<true>', () => {
            type Expected = true;
            type Actual = LogicHandler<$UseVote<true>, $Settings>;
            type Result = IsExact<Expected, Actual>;
          ...
          it('should return false for $UseVote<false>', () => {
            type Expected = false;
            type Actual = LogicHandler<$UseVote<false>, $Settings>;
            type Result = IsExact<Expected, Actual>;
          ...
          it('should return boolean for $UseVote<boolean>', () => {
            type Expected = boolean;
            type Actual = LogicHandler<$UseVote<boolean>, $Settings>;
            type Result = IsExact<Expected, Actual>;
