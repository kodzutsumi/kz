...
import type { OrResult } from './_internal/mod.ts';

/**
 * Type representing a logical OR operation on two boolean operands and returns a type based on the provided settings.
 *
 * ## Capabilities
 * - {@linkcode UseUnsafe}
 ...
 *
 * @see [Or reference - Logic matrix](https://docs.i11n.io/kz/util/logic/ref/or/#logic-matrix) for logic resolution of the `Or` type.
 * @see [Or reference - Behavior matrix](https://docs.i11n.io/kz/util/logic/ref/or/#behavior-matrix) for detailed `Or` behavior based on different capability combinations.
 */
export type Or<
  OperandA extends boolean,
  OperandB extends boolean,
  Settings extends LogicCapSet = LogicDefaults,
> = If<OrResult<OperandA, OperandB>, Settings>;
