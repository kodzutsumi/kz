...
/**
 * A tuple representing the 8th degree of a polynomial.
 *
...
/**
 * A tuple containing exactly 8 elements.
 *
 * @template El1 - The type of the first element.
 * @template El2 - The type of the second element.
 * @template El3 - The type of the third element.
...
export type Octuple<
  ...
  El7 = El6,
  El8 = El7,
> = Octic<El1, El2, El3, El4, El5, El6, El7, El8>;
...
export type Octonary<
  ...
  El7 = El6,
  El8 = El7,
> = Octuple<El1, El2, El3, El4, El5, El6, El7, El8>;
/**
 * A tuple containing exactly 8 elements.
 *
 * @template El1 - The type of the first element.
