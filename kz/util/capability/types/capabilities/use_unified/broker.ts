 ...
 *
 * Use this setting to invoke the unified behavior of a type that supports
 * the {@linkcode $UseUnified} capability consumer.
 *
 * @see {@linkcode $AsDistributed} for the distributive (default implied) behavior broker of this capability.
 */
export type $AsUnified = $UseUnified<true>;

/**
 * The distributive behavior broker of the {@linkcode $UseUnified} capability.
 *
