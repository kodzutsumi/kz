...
describe('PickCap', () => {
  describe('Capability flag consumer', () => {
    ...
    describe('UseStream', () => {
      it('should pick the setting from CapBrokerSet', () => {
        type Actual = PickCap<UseStream<true>, UseStream, false>;
      ...
      it('should be the DefaultType if missing from the CapBrokerSet', () => {
        type Actual = PickCap<UseUnsafe<false>, UseStream, false>;
  ...
  describe('multiple capabilities', () => {
    it('should pick the setting from CapBrokerSet', () => {
      ...
      type Actual = PickCap<CapBrokerSet, UseInverted, never>;
      type Expected = AsInverted;
      type Result = IsExact<Actual, Expected>;
    ...
    it('should be the DefaultType if missing from the CapBrokerSet', () => {
      ...
      type Actual = PickCap<CapBrokerSet, UseInverted, false>;
      type Expected = AsInitial;
      type Result = IsExact<Actual, Expected>;
