 ...
 * `UseInverted` and {@linkcode UseReversed} are similar capabilities that both
 ...
 * used. `UseInverted` is generally north-south oriented, while
 * {@linkcode UseReversed} is generally east-west oriented. The specific
