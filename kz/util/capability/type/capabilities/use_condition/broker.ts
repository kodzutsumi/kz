...
/**
 * A special capability setting utility that defines the types for the {@linkcode Then} and {@linkcode Else} capabilities based on the provided `ThenType` and `ElseType`.
 *
