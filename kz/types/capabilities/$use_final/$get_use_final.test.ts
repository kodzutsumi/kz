...
import type { $AsTrueFinal, $GetUseFinal, $Then } from '@kz/types/capabilities';
...
class _ {
  ...
  t1(): void {
    type Expected = false;
    type Actual = $GetUseFinal<$SettingsExclude>;
    type Result = IsExact<Expected, Actual>;
  ...
  t2(): void {
    type Expected = true;
    type Actual = $GetUseFinal<$SettingsExclude, true>;
    type Result = IsExact<Expected, Actual>;
