  ...
  describe('$ConditionOf<string, number>', () => {
    describe('$AsInitial (default/implied)', () => {
      ...
      describe('$AsUnsafe', () => {
        ...
        describe('$AsMajority', () => {
          type Settings = $AsMajority & $AsUnsafe & $ConditionOf<string, number>;
    ...
    describe('$AsInverted', () => {
      describe('$AsSafe (default/implied)', () => {
        ...
        describe('$AsMajority', () => {
          type Settings = $AsMajority & $AsInverted & $ConditionOf<string, number>;
      ...
      describe('$AsUnsafe', () => {
        describe('$AsRunoff (default/implied)', () => {
          type Settings = $AsUnsafe & $AsInverted & $ConditionOf<string, number>;
        ...
        describe('$AsMajority', () => {
          type Settings = $AsMajority & $AsUnsafe & $AsInverted & $ConditionOf<string, number>;
